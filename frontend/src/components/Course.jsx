...
const Course = () => {
  ...
  return (
    <div className="min-h-screen mt-20 flex flex-col items-center">
      ...
      <button
        className="bg-[#E44B97] hover:bg-pink-700 text-white pl-3 pr-3 pt-1 pb-1 text-xl rounded mt-5"
        onClick={() => navigate('/')}
      >
        Back
      </button>
      ...
      <div className="w-full px-6 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {book.map((items) => (
          ...
          >
            ...
            <button className="text-sm bg-pink-500 mt-3 text-white pl-2 pr-2 pt-1 pb-2 rounded">
              Buy Now
            </button>
          </div>
        ))}
