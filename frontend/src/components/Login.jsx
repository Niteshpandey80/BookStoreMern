      ...
      <div className='bg-white rounded-xl shadow-2xl w-96 p-6 relative'>
        ...
        <form className='flex flex-col gap-4'>
          <div>
            ...
            <input type="email" placeholder='Enter your email' className='w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-pink-500' />
          </div>
          <div>
        ...
        <p className='text-center text-sm text-gray-600 mt-4'> Not registered?{" "}
          <a href="#" className='text-pink-500 hover:underline'>Signup</a>
        </p>
      </div>
    </div>
  )
